...
namespace VideoLAN
{
    public class MediaPlayer : InternalMediaPlayer
    {
        public MediaPlayer(IntPtr javaReference, Android.Runtime.JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }
        ...
        public MediaPlayer(VLCMedia media) : base(media)
        {
        }
